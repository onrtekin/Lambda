...
public class C5_Method_Referance_String {
    ...
    public static void buyukHarfBosluklu(List<String> l){
        l.stream().
                map(t->t.split("")).
    ...
    public static void eIleBaslayanlar(List<String> l){
        l.stream().filter(t->t.startsWith("E")).forEach(Methods::yazString);
